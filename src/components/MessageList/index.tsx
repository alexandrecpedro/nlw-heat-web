...
// criar uma fila de mensagens (array que recebe lista de mensagens)
const messagesQueue: Message[] = [];

const socket = io('http://localhost:4000');
// quando receber nova mensagem, elas serão armazenadas dentro dessa fila
...
export function MessageList() {
    ...
    useEffect(() => {
        // executa a cada 3 segundos (3000 milissegundos)
        const timer = setInterval(() => {
            // verifica se na fila há pelo menos uma mensagem
            if (messagesQueue.length > 0) {
                // sobrepondo um array com um novo array contendo novas informações, via função
                // estado anterior (prevState)
                setMessages(prevState => [
                    // primeira mensagem na primeira posição
                    messagesQueue[0],
                    // mensagem que já tinha, na posição 0
                    prevState[0],
                    // mensagem que já tinha, na posição 1
                    prevState[1]
                    // filtrar para checar se há valores falsys (undefined, null, false) e removê-los
                ].filter(Boolean))
                // remover o primeiro item que estava na fila
                messagesQueue.shift();
            }
        }, 3000)
    }, [])
    ...
    useEffect(() => {
        // chamada pra api (busca os dados que desejo)
    ...
    return (
        <div className={styles.messageListWrapper}>
            <svg width="280" height="24" viewBox="0 0 280 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path d="M280 0V23.4378H271.178V8.19369L267.296 8.67007V2.09602L280 0Z" fill="white"/>
                <defs>
                <linearGradient id="paint0_linear_61336:1529" x1="-3.30879e-06" y1="0.634187" x2="50.8161" y2="88.2688" gradientUnits="userSpaceOnUse">
